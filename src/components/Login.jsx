        ...
        <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-violet-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4'>
            <div className='w-full max-w-lg backdrop-blur-lg bg-white/30 dark:bg-gray-800/50 rounded-2xl p-8 shadow-xl border border-violet-100 dark:border-gray-700/20'>
                <div className='mb-6 flex flex-col items-center'>
                    ...
                    <div className={`w-20 h-20 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 dark:from-cyan-500 dark:via-blue-500 dark:to-purple-500 rounded-full p-0.5 shadow-lg ${isLoading ? 'animate-pulse' : ''}`}>
                        <div className='w-full h-full rounded-full bg-white/95 dark:bg-gray-900/95 flex items-center justify-center p-4 backdrop-blur-sm'>
                            <Logo 
                                width='100%'
                                className={`text-gray-800 dark:text-white ${isLoading ? 'animate-spin-slow' : ''}`}
                            />
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit(login)} className='mt-8 space-y-4'>
                    ...
                    <Button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full py-2 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 dark:from-cyan-500 dark:via-purple-500 dark:to-pink-500 text-white text-sm rounded-lg transition-all duration-200 font-medium ${isLoading ? 'opacity-75 cursor-not-allowed' : 'hover:opacity-95'}`}
                    >
